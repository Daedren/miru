<script context='module'>
  ...
  import { ScreenshotLocations, ScreenshotLocationDefault, ScreenshotLocation } from '@/modules/screenshot.js'
...
<script>
  ...
  function handleFolder (destinationType) {
    window.IPC.emit('dialog', destinationType)
  }
  window.IPC.on('path', (data, destination) => {
    if (destination === 'screenshotFilesystemPath') settings.screenshotFilesystemPath = data
    if (destination === 'torrentPath') settings.torrentPath = data
    console.error(data)
    ...
    <div class='h-full w-full overflow-y-auto'>
      <Tab>
        <div class='root p-20 m-20'>
          ...
          <div class='input-group mb-10 w-400 form-control-lg' data-toggle='tooltip' data-placement='top' data-title='Where to save screenshots'>
            <div class='input-group-prepend'>
              <span class='input-group-text w-250 justify-content-center'>Screenshot location</span>
            </div>
      ...
      <Tab>
        <div class='root p-20 m-20'>
          <div
            ...
            <div class='input-group-prepend'>
              <button type='button' use:click={() => handleFolder('torrentPath')} class='btn btn-primary input-group-append'>Select Folder</button>
            </div>
